...
//sql query to be executed
   ...
   if ($result){
    ...
    echo "The recorded was not inserted successfully because of this error ----> ".mysqli_error($conn);
}
}
}
  ...
  <div class="modal-content">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
          <a class="navbar-brand" href="#"><img src="/crud/logo.svg.png" height="28px" alt=""></a>
